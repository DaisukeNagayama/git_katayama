...
exName = 'ex0801stl';
%久米のフォルダ
Dir_kume = 'C:\Users\kume\Documents\MATLAB\04_ProjectionFromVertex\ProjectionFromVertex_v1.4';
...
% 結果を保存する。
FileName = sprintf('Result_GDID_D%dQ%d_Query%d', DatabaseGeodesicID, ...
                   QueryGeodesicID, nQuery);
cd Result
% save(FileName, 'ExperimentResult', 'DataSet');
save(FileName, 'ExperimentResult');
cd ..